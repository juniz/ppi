            ...
            ->query(
                DataHais::query()
                    ...
                    ->select([
                        ...
                        DB::raw('SUM(data_HAIs.HAP) as denumerator'),
                        DB::raw('ROUND((COUNT(DISTINCT data_HAIs.no_rawat)/SUM(data_HAIs.HAP))*1000,2) as laju_hap'),
                    ])
                    ->where('data_HAIs.HAP', '>', 0)
