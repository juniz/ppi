...
class LajuPLEB extends Page implements HasTable
{
    ...
    protected static ?string $title = 'Laju PLEB';
            ...
            ->query(
                DataHais::query()
                    ...
                    ->select([
                        ...
                        DB::raw('ROUND((COUNT(DISTINCT data_HAIs.no_rawat)/SUM(data_HAIs.PLEB))*1000,2) as laju_pleb'),
                    ])
                    ->where('data_HAIs.PLEB', '>', 0)
