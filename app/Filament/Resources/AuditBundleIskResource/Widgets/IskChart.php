...
namespace App\Filament\Resources\AuditBundleIskResource\Widgets;

use App\Models\AuditBundleIsk;
use Leandrocfe\FilamentApexCharts\Widgets\ApexChartWidget;

class IskChart extends ApexChartWidget
{
    /**
     * Chart Id
     *
     * @var string
     */
    protected static ?string $chartId = 'iskChart';
    ...
    protected function getData(string $year): array
    {
        ...
        foreach (range(1, 12) as $month) {
            $data[] = AuditBundleIsk::rataTtlNilai($month, $year);
        }
        return $data;
    }
}
